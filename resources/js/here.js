if(navigator.geolocation) {
      ...
      let map = new H.Map(
        ...
        map.addEventListener('dragstart', function(ev) {
            ...
            if (target instanceof H.map.Marker) {
                let targetPosition = map.goToScreen(target.geoGeometry());
 ...
 //Open URL direction
    function openDirection(lat, lng, id) {
        window.open(`/space/${id}?from=${objLocalCoord.latitude},
        ${objLocalCoord.longitude}&to=${lat},${lng}`, "_self");
    }
    })
